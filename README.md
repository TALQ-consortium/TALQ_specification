...
# Trademark Notice
The word TALQ and the TALQ logo are registered trademarks of the TALQ Consortium. If you plan to reference TALQ in any form, please consult the **TALQ Logo Usage Guide** in the [TALQ website](https://www.talq-consortium.org/2-why-talq/policies.html) for detailed guidelines on appropriate usage. Use of the TALQ logo is restricted to members only. Proper usage helps preserve the value and integrity of the TALQ brand for the entire smart city community.
